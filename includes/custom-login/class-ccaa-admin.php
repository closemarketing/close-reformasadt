...
class CLOSE_WPAdmin {
	...
	public function custom_login_logo() {
		...
		h1 a { background-image:url(' . esc_url( trailingslashit( plugin_dir_url( __FILE__ ) ) ) . 'logomini.svg) !important; width: 84px !important; background-size: 84pxpx !important; height: 90px !important; }
		body.login {background: #F4FBFE; }
	...
	public function change_bar_color() {
		...
		echo '<style>
			...
			.wc-install.ultp-pro-notice, .license-warning.notice.notice-error.is-dismissible {	display: none; }#wpadminbar #wp-admin-bar-wp-logo>.ab-item {
				padding: 0;
				background-image: url( ' . esc_url( trailingslashit( plugin_dir_url( __FILE__ ) ) ) . '/logomini.svg) !important;
				background-size: 88%;
